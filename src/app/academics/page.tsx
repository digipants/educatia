      ...
      <section className="grid gap-6 md:grid-cols-2 items-center">
        <div className="space-y-3">
          ...
          <h1 className="text-4xl font-bold text-slate-900">
            Free academic support for Class 9 to 12
          </h1>
          <p className="text-slate-700 leading-relaxed">
            This program is built to ensure no deserving student is left behind
            due to financial constraints. It strengthens board exam readiness
            through guided learning and disciplined study support.
          </p>
        </div>
        <div className="relative h-72 overflow-hidden rounded-2xl shadow-lg">
          <Image
            src="https://images.unsplash.com/flagged/photo-1574097656146-0b43b7660cb6?q=80"
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <article className="card space-y-3">
          ...
          <p className="text-sm text-slate-700">
            Class 9 to 12 students who need structured and free academic
            support.
          </p>
